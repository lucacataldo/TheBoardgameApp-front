...
class TradePending extends React.Component {
    ...
    <div className="card-body">
        <div className="row justify-content-center align-self-center mt-1">
            ...
            <button type="button" class="btn btn-success mx-2 float-right"><FontAwesomeIcon icon={faCheck} /> Completed</button>
            <button type="button" class="btn btn-info mx-2 float-right"><FontAwesomeIcon icon={faCommentDots} /> Chat</button>
            <button type="button" class="btn btn-primary mx-2 float-right"><FontAwesomeIcon icon={faEye} /> View</button>
            </div>        
        </div>
